...
//			try {
//				
//				List<AnneeScolaire> anneescolaires = anneescolaireDao.getAnneeScolaire();
//				request.setAttribute("anneescolaires", anneescolaires);
//				
//			}catch(Exception e) {
//				throw new ServletException("Euureur :"+e.getMessage());
//			}
...
//			classe.setDescription_classe(description_classe);
			...
			try {
				anneescolaireDao.ajoutAnneeScolaire(classe);
//				anneescolaireDao.ajoutClasse(classe);
				
				List<AnneeScolaire> anneeScolaires = anneescolaireDao.getListAnneeScolaire();
				request.setAttribute("anneeScolaires", anneeScolaires);
